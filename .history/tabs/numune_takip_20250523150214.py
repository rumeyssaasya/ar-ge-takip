...
class NumuneTakipApp:
    ...
    def create_widgets(self):
        ...
        tk.Label(frame, text="Kod/Proje Adi/Ad Ara").grid(row=7, column=0)
    ...
    #"""Seçili numuneleri PDF olarak kaydeder"""
        ...
        column_widths = [30, 35, 35, 15, 10, 20, 15, 30]
    ...
    def export_all_to_pdf(self):
        ...
        pdf.set_font("Arial", style='B',size=12)
        headers = ["Kod","Proje Adi", "Ad", "Raf", "Miktar", "Birim", "Tarih", "Yer"]
        column_widths = [30, 35, 35, 15, 10, 15, 20, 30]
    ...
    def detay_goster(self):
        DOSYA_KLASORU = r"ARGE\Ar-Ge Envanter Takip Sistemi\Numuneler"
