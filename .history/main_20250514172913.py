...
def sekme_ac():
    ...
    tk.Label(yeni_pencere, text="E-posta:").pack(pady=5)
    tk.Entry(yeni_pencere).pack(pady=5)

    tk.Label(yeni_pencere, text="Ad:").pack(pady=5)
    tk.Entry(yeni_pencere).pack(pady=5)

    tk.Label(yeni_pencere, text="Soyad:").pack(pady=5)
    tk.Entry(yeni_pencere).pack(pady=5)
