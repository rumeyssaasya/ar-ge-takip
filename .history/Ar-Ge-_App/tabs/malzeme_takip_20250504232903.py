...
class MalzemeTakipApp:
    ...
    def create_widgets(self):
        ...
        tk.Button(btn_frame, text="Malzeme Ekle", command=self.add_material).grid(row=0, column=0)
        tk.Button(btn_frame, text="Malzeme Güncelle", command=self.update_material).grid(row=0, column=1)
        tk.Button(btn_frame, text="Malzeme Sil", command=self.delete_material).grid(row=0, column=2)
        ...
        tk.Button(btn_frame, text="Tüm Malzemeleri Listele", command=self.list_all_materials).grid(row=0, column=5)
