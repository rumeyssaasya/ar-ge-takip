...
class DemirbasTakipApp:
    ...
    def create_widgets(self):
        ...
        self.entry_alim_tarihi = tk.Entry(frame)
...
=======
        ...
        tk.Button(btn_frame, text="Tümünü Listele", command=self.list_all_demirbaslar).grid(row=0, column=4, padx=5)
>>>>>>> upstream/main
...
>>>>>>> upstream/main
    ...
    def export_pdf(self):
<<<<<<< HEAD
    #"""Seçili demirbaşı PDF olarak kaydeder"""
        selected_items = self.tree.selection()  # Seçili satırları al
...
>>>>>>> upstream/main
        ...
        pdf = FPDF()
        pdf.add_page()
        # Burada font ekliyoruz, ama arial.ttf yoksa başka bir font kullanmalısın!
        try:
<<<<<<< HEAD
            pdf.add_font('Arial', '', 'arial.ttf', uni=True)
            pdf.set_font('Arial', '', 14)
        except RuntimeError:
            pdf.set_font('Helvetica', '', 14)  # Arial bulunamazsa varsayılan font kullan

        # Başlık
        pdf.cell(0, 10, "Demirbaş Listesi", ln=True, align='C')
        pdf.ln(10)
...
=======
            ...
            # Sütun başlıkları
            headers = ["Kod", "Ad", "Marka", "Alım Tarihi", "Durum"]
            col_widths = [25, 40, 30, 35, 25, 30, 35, 20]
