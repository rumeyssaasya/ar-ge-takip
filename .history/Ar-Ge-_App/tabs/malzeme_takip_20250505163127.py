...
class MalzemeTakipApp:
    ...
    DOSYA_KLASORU = r"C:\Users\aciog\Documents\Dosyalar"
    ...
    def detay_goster():
        ...
        degerler = tree.item(secilen)["values"]
    ...
    # Tkinter arayüzünün devamına eklenebilir
    detay_buton = tk.Button(pencere, text="Detay", command=detay_goster)
    detay_buton.pack(pady=10)
